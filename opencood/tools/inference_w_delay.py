...
def main():
    ...
    for use_laplace in use_laplace_options:
        ...
        for overhead in sync_overhead:
            ...
            ap30, ap50, ap70 = eval_utils.eval_final_results(result_stat,
                                opt.model_dir, global_sort_detections=True, infer_info = noise_level)
            ...
            yaml_utils.save_yaml(dump_dict, os.path.join(opt.model_dir, f'AP030507{suffix}_w_gs.yaml'))
            
            ap30, ap50, ap70 = eval_utils.eval_final_results(result_stat,
                                opt.model_dir, global_sort_detections=False, infer_info = noise_level)
            ...
            dump_dict = {'ap30': AP30 ,'ap50': AP50, 'ap70': AP70}
            yaml_utils.save_yaml(dump_dict, os.path.join(opt.model_dir, f'AP030507{suffix}_wo_gs.yaml'))
