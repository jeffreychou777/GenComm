...
from opencood.models.pnpda_modules.adapter import (
    TransformerDecoder,
    TransformerEncoder,
)
...
class HeterModelBaselineWPnpda(nn.Module):
    def __init__(self, args):
        super(HeterModelBaselineWPnpda, self).__init__()
        self.args = args
    ...
    def model_train_init_pnpda(self):
    ...
    def forward(self, data_dict):
        ...
        modality_feature_dict = OrderedDict()
        ...
        with torch.no_grad():
            ...
            query = self.proj_q(ego_features)
            key = cav_features
