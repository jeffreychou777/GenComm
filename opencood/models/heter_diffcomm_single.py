...
class HeterDiffcommSingle(nn.Module):
    def __init__(self, args):
        super(HeterDiffcommSingle, self).__init__()
        ...
        self.fix_modules = ['diffcomm', 'reg_head', 'dir_head']  # TO ADD backbone and encoder 
    ...
    def forward(self, data_dict):
        ...
        gt_features = feature
        conditions = self.cls_head(feature)
        gen_data_dict = self.diffcomm.forward_single(feature, conditions,)
        feature = gen_data_dict['pred_feature']
        ...
        output_dict.update({'cls_preds': cls_preds,
                            'reg_preds': reg_preds,
                            'dir_preds': dir_preds})
        output_dict.update({'gt_feature': gt_features,
