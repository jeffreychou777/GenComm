...
class SplitAttn(nn.Module):
    ...
    def forward(self, window_list, affine_matrix=None):
        ...
        # only dist bias
        self.visualize_angle_bias(distance_bias, save_path='/home/junfei.zhou/DATACENTER2/data/code/DiffComm/bias_vis/distance_bias.png')
        out = sw * x_attn[:, :, :, 0:self.input_dim] + \
...
class Enhancerv10(nn.Module):
    '''
    v10 is v7 add distance bias in split_attn 
    '''
    def __init__(self, C, win_size, num_heads):
        super().__init__()
...
def test_sparse():
    ...
    block = Enhancerv10(C, win_size, num_heads,)
