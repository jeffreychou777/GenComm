...
class SplitAttn(nn.Module):
    def __init__(self, input_dim):
        ...
        self.distance_bias_table = nn.Parameter(torch.ones(self.distance_bins))
    ...
    def get_distance_bias(self, x, affine_matrix, H, W):
        ...
        distance_bias = 1.0 + F.sigmoid(self.distance_bias_table[dist_bins])  # (B, N)
...
class Enhancerv9(nn.Module):
    '''
    v9 is v7 add angle bias in split_attn 
    '''
    def __init__(self, C, win_size, num_heads):
        super().__init__()
...
#     block = Enhancerv9(C, win_size, num_heads,)
