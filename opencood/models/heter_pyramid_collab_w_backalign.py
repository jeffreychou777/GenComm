...
class HeterPyramidCollabWBackalign(nn.Module):
    def __init__(self, args):
        super(HeterPyramidCollabWBackalign, self).__init__()
        self.args = args
        ...
        for modality_name in self.modality_name_list:
            ...
            self.fix_modules += [f"backbone_{self.ego_modality}", f"encoder_{self.ego_modality}"]
