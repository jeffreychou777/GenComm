...
def getIntermediateheterv2xrealinferFusionDataset(cls):
    """
    cls: the Basedataset.
    """
    Intermediate_heter_Fusion_Dataset = getIntermediateheterv2xrealFusionDataset(cls)

    class Intermediate_heter_v2xreal_Infer_Fusion_Dataset(Intermediate_heter_Fusion_Dataset):
        """
        We add 'use_cav' to control the number of cars that really participate in collaboration.
        We use 'max_cav' to genenrate all gt boxes in the scene.
        """
    ...
    return Intermediate_heter_v2xreal_Infer_Fusion_Dataset
