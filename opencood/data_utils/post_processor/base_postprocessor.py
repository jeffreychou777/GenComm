...
class BasePostprocessor(object):
    ...
    def __init__(self, anchor_params, train=True, class_names=None):
    ...
    def generate_object_center_stamp(self,
                               cav_contents,
                               reference_lidar_pose,
                               enlarge_z=False,
        ...
        box_utils.project_world_objects_stamp(tmp_object_dict,
                                        output_dict,
                                        reference_lidar_pose,
                                        filter_range,
                                        self.params['order'],
    ...
    def generate_visible_object_center_stamp(self,
                               cav_contents,
                               reference_lidar_pose,
                               enlarge_z=False,
                               mask_outside_range=True):
        ...
        box_utils.project_world_visible_objects_stamp(tmp_object_dict,
                                        output_dict,
                                        ego_lidar_pose,
                                        inf_filter_range,
                                        self.params['order'],
    ...
    def generate_gt_bbx_v2xreal(self, data_dict):
        """
        The base postprocessor will generate 3d groundtruth bounding box.
    ...
    def generate_object_center_v2xreal(self,
        ...
        box_utils.project_world_objects_v2xreal(tmp_object_dict,
                                        output_dict,
                                        reference_lidar_pose,
                                        filter_range,
                                        self.params['order'])
